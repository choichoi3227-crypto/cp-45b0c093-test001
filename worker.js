...
const ghRepo  = (e) => e.GH_REPO        || "cp-45b0c093-test001";
const ghToken = (e) => e.GITHUB_TOKEN   || "";
const ghPages = (e) => e.GH_PAGES_URL   || "https://choichoi3227-crypto.github.io/cp-45b0c093-test001";
...
async function ghRaw(env, filePath, ttl = 300) {
  ...
  if (!o || !r || o === "choichoi3227-crypto" || r === "cp-45b0c093-test001") return null;
  try {
...
export default {
  async fetch(req, env, ctx) {
    ...
    if (pagesBase && pagesBase !== "https://choichoi3227-crypto.github.io/cp-45b0c093-test001") {
      try {
